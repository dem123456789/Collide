...
## Updated: 2/12/2012 - Stefan Ludlow ##
########################################
...
SOURCES            = main.c myLib.c font.c text.c splash.c enter.c you_win.c you_lose.c warning.c game.c

###### --- System Settings (Update these for your system)
###### Mac example paths make sure to comment out the windows
###### paths if you use these
#DKPATH             = C:/Users/samsung/Desktop/学习/资料/CS1372/GBA/WindowsdevkitARM/devkitARM/bin
#CCPATH             = E:/Cygwin/root/bin
#VBASIM             = C:/Users/samsung/Desktop/学习/资料/CS1372/GBA/VisualBoyAdvance-1.7.2/VisualBoyAdvance.exe
